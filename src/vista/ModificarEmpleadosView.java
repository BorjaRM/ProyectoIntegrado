...
public class ModificarEmpleadosView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModificarEmpleadosView frame = new ModificarEmpleadosView();
	...
	public ModificarEmpleadosView() {
		...
		gbl_panel_1.columnWidths = new int[]{0, 0, 255, 0};
		gbl_panel_1.rowHeights = new int[]{15, 0, 0, 0, 0, 0, 0, 0, 0, 0};
		...
		panel_1.add(verticalGlue, gbc_verticalGlue);
