...
public class PrincipalEmpleadoView extends JPanel {
	...
	public PrincipalEmpleadoView() {
		...
		gridBagLayout.columnWidths = new int[]{0, 0, 104, 0, 0, 0, 0, 104, 0};
		gridBagLayout.rowHeights = new int[]{0, 0, 67, 0, 0, 0, 62, 0};
		...
		gbc_lblSalidasHoy.insets = new Insets(0, 0, 5, 0);
		gbc_lblSalidasHoy.gridx = 7;
		...
		gbc_list_Salidas.insets = new Insets(0, 0, 5, 0);
		gbc_list_Salidas.fill = GridBagConstraints.BOTH;
		gbc_list_Salidas.gridx = 7;
		...
		gbc_lblIncidenciasActivas.gridy = 5;
		...
		gbc_lblHabitacionesDisponibles.insets = new Insets(0, 0, 5, 0);
		gbc_lblHabitacionesDisponibles.gridx = 7;
		gbc_lblHabitacionesDisponibles.gridy = 5;
		...
		gbc_list_Habitaciones.gridx = 7;
		gbc_list_Habitaciones.gridy = 6;
